...
function detectBrowser(userAgent) {
	const obj ={'Gecko':'Mozilla Firefox',
						 'AppleWebKIt':'Google Chrome',
						 'Trident':'Internet Explorer'}
//  return obj[userAgent.match(/Gecko\/20100101|AppleWebKIt|Trident/)[0]]
	return userAgent.match(/Gecko|AppleWebKIt|Trident/)
}
...
for (var i = 0; i < uAgt.length; i++){
  ...
  console.log(detectBrowser(uAgt[i]), rep)
}
