# https://edabit.com/challenge/mrKbfWBjQA2c3amwN
def mult_table(n):
    return [[i*c for c in range(1,n+1)] for i in range(1,n+1)]

print(mult_table(1),[[1]])
print(mult_table(2),[[1,2],[2,4]])
print(mult_table(3),[[1,2,3],[2,4,6],[3,6,9]])
print(mult_table(4),[[1,2,3,4],[2,4,6,8],[3,6,9,12],[4,8,12,16]])
print(mult_table(5),[[1,2,3,4,5],[2,4,6,8,10],[3,6,9,12,15],[4,8,12,16,20],[5,10,15,20,25]])
